...
#End If
    ...
    Public Function ConnectToDevice(ByVal deviceIndex As Integer, ByVal frameRate As Integer, ByVal windowSize As Size, ByVal frameSize As FrameSizes, ByVal hParent As IntPtr) As Boolean
        ...
        If Form1.ComboBox_FrameSize.SelectedIndex = 6 Then
            hres = 4
            vres = 6
            vlength = 3
        End If
        ...
        Dim iSize As New Size(CInt(frameSize.ToString.Substring(1, hres)), CInt(frameSize.ToString.Substring(vres, vlength)))
        '''''''''
        Try
        ...
        Catch
            ...
            If unsupportedVideo Then
                MessageBox.Show("The (imageSize) resolution isn't supported by the camera.", "CubeScan", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Else
                MessageBox.Show("An unknown error happened when connecting to the camera.", "CubeScan", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End If
            Return False
        End Try
    ...
    Private Sub Tmr2_Tick(ByVal sender As Object, ByVal e As System.EventArgs) Handles TmrSaved.Tick
        ...
        Catch ex As Exception
            'Form1.ErrorMessage = ex.ToString & vbCrLf & "ImagePathName=" & ImagePathName & "   " & "ImgFormat=" & ImgFormat.ToString
            'Form1.ErrorSub = "Tmr2_Tick"
            'Form1.WriteErrorLog()
        End Try
...
#End If
        ...
        saveImage = False
        getImage = False
        'ImagePathName = ""     'Edited these on 1/27/2014 to prevent error
        'ImgFormat = Nothing
